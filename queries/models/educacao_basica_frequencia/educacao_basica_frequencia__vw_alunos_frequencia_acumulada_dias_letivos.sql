...
WITH frequencia_acumulada AS (
    ...
    FROM {{ ref('educacao_basica_frequencia__numeroDeAulasCte') }} NUM
    LEFT JOIN (
        ...
        LEFT JOIN {{ ref('brutos_gestao_escolar__aluno_justificativa_falta') }} AFJ
        ...
        LEFT JOIN {{ ref('brutos_gestao_escolar__tipo_justificativa_falta') }} TJF
