...
sme_frequencia_queries = {
    ...
    "esc_escola": {
        ...
        "execute_query": """
            ...
            esc_funcionamentoFim,
            esc_situacao,
            esc_dataCriacao,
            esc_dataAlteracao,
            esc_controleSistema,
            esc_atoCriacao,
            esc_dataPublicacaoDiarioOficial,
            esc_codigoNumeroMatricula,
            esc_autorizada,
    ...
    "aca_aluno_justificativa_falta": {
        "dataset_id": "educacao_basica_frequencia",
        "partition_columns": "afj_dataAlteracao",
        "partition_date_format": "%Y-%m-%d",
        "break_query_frequency": "month",
        "break_query_start": "current_month",
        "break_query_end": "current_month",
    ...
    "mtr_matricula_turma": {
        "dataset_id": "educacao_basica_frequencia",
        "partition_columns": "mtu_dataAlteracao",
        "partition_date_format": "%Y-%m-%d",
        "break_query_frequency": "month",
        "break_query_start": "current_month",
        "break_query_end": "current_month",
